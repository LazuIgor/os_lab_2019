...
main и showit находятся в сегменте кода.
cptr и buffer1 находятся в сегменте данных и BSS соответственно.
Переменная i находится в стеке.
buffer2 выделяется в куче с помощью malloc.
